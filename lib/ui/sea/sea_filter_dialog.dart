...
class SeaFilterDialog extends StatefulWidget {
  @override
  _SeaFilterDialogState createState() => _SeaFilterDialogState();
}

class _SeaFilterDialogState extends State<SeaFilterDialog>
    with BlocProviderMixin {
  SeaFilterCondition _condition;

  @override
  void initState() {
    super.initState();

    _condition = seaBloc.state.condition.copy();
  }
                ...
                children: [
                  ...
                  ButtonBar(
                    ...
                    children: [
                      ElevatedButton(
                        onPressed: () {
                          seaBloc.add(SetConditionSeaEvent(_condition));
